  ...
  return (
    <div className="bg-black py-[140px]">
      <h1 className="text-5xl font-bold text-white text-center">
        My <span className="text-[#cd5ff8]">Skillset</span>
      </h1>
      ...
      <h1 className="text-5xl font-bold text-center text-[#cd5ff8] mt-[140px]">
        Tools <span className="text-white">| use</span>
      </h1>
      <div className="flex align-center text-center justify-center justify-items-center mt-[100px] max-w-[1400px] mx-auto ">
        <div className="border-solid border-2 border-[#cd5ff8] p-6 w-[250px] transform transition-transform duration-500 hover:scale-110  rounded-lg">
          <a href="https://code.visualstudio.com/">
            <SiVisualstudiocode className="w-[70px] h-[80px] text-white" />
          </a>
        </div>
        <div className="border-solid border-2 border-[#cd5ff8] p-6 w-[250px] transform transition-transform duration-500 hover:scale-110  rounded-lg">
          <a href="https://vercel.com/">
            <SiVercel className="w-[70px] h-[80px] text-white" />
          </a>
        </div>
        <div className="border-solid border-2 border-[#cd5ff8] p-6 w-[250px] transform transition-transform duration-500 hover:scale-110  rounded-lg">
          {" "}
          <a href="https://www.microsoft.com/en-us/windows?r=1">
            <GrWindows className=" w-[70px] h-[80px] text-white" />
          </a>
        </div>
        <div className="border-solid border-2 border-[#cd5ff8] p-6 w-[250px] transform transition-transform duration-500 hover:scale-110  rounded-lg">
          <a href="https://www.netlify.com/">
            <SiNetlify className="w-[70px] h-[80px] text-white" />
          </a>
        </div>
      </div>
    </div>
